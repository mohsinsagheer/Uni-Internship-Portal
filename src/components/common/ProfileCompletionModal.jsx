...
export default function ProfileCompletionModal({ isOpen, onClose }) {
  ...
  const [formData, setFormData] = useState({
    ...
    program: currentUser?.program || (isStudent ? 'BS Computer Science' : ''),
    semester: currentUser?.semester || (isStudent ? '7th Semester' : ''),
    cgpa: currentUser?.cgpa || (isStudent ? '3.00' : ''),
    creditHoursCompleted: currentUser?.creditHoursCompleted || (isStudent ? '110' : ''),
    internshipCompany: currentUser?.internshipCompany || '',
    internshipRole: currentUser?.internshipRole || '',
    internshipMode: currentUser?.internshipMode || (isStudent ? 'On-site' : ''),
    internshipDuration: currentUser?.internshipDuration || (isStudent ? '8 Weeks (Mandatory)' : ''),
    department: currentUser?.department || 'Department of Computer Science',
